...
type IsContractsFileMissing<TYes, TNo> = typeof contractsData extends null
  ? TYes
  : TNo;
type ContractsDeclaration = IsContractsFileMissing<
...
export type UseScaffoldEventConfig<
  ...
  TEventInputs extends AbiEventArgs<ContractAbi<TContractName>, TEventName> &
    any[]
> = {
  contractName: TContractName;
} & IsContractsFileMissing<
